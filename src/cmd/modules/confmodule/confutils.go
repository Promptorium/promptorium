...
func (c *Config) GetBottomDecoration() (string, int) {
	//TODO: Implement multiple styles

	decorationString := "  "
	decorationLen := 3
	decorationString = c.ColorizeString(decorationString, c.Theme.SecondaryColor, c.Theme.BackgroundColor)
...
func addColor(text string, fgcode string, bgcode string, bold bool, underline bool, shell context.Shell) string {
